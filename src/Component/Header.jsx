    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <nav
            className={`lg:flex items-center justify-center lg:space-x-8 ${isOpen ? "block" : "hidden"
              } lg:block`}
          >
            <ul
              className={`flex text-lg max-lg:bg-white items-center justify-center max-lg:items-start ${isOpen ? "block" : "hidden"
